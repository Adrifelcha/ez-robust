...
#' @title Main function to store simulation study results
#' @description This function takes the combined output from `load_seedOutput`,
#' identifies all model conditions (e.g., "EZ_clean", "EZ_contaminated"),
#' processes each one, and saves the structured results into separate .RData files.
#' @param output The list object generated by `load_seedOutput`.
#' @param saveTo The directory where the final .RData files will be saved.
#' @param simStudyName A base name for the output files.
