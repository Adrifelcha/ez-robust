# Demos: Simulation studies

We generated thousands of independent datasets containing choice and RT data from a Wiener diffusion process. Each dataset used a unique set of randomly generated true parameter values.




### Two types of simulation studies simulation studies
...
We generated thousands of independent datasets containing choice and RT data from a Wiener diffusion process. 
...
Each dataset used a unique set of randomly generated true parameter values.

For each data set, we generated one random value for the population mean boundary $\mu_\alpha$, the population mean nondecision time $\mu_\tau$, and the population-level intercept for the drift rate $\mu_\nu$ by sampling from three uniform distributions snapping a wide range of possible values:
