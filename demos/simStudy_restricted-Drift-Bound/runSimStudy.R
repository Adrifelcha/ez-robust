...
output_dir <- here("demos", "simStudy_restricted-Drift-Bound", "samples")
log_dir <- here("demos", "simStudy_restricted-Drift-Bound", "logs")
...
settings <- c(settings, list("true_sdevs" = list("bound_sdev" = 0.5, "nondt_sdev" = 0.1, "drift_sdev" = 0.75),
                             "true_means" = list("bound_mean" = c(3.5, 4), "nondt_mean" = c(0.2, 0.4), "drift_mean" = c(-1, 1))))
